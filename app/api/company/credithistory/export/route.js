...
export async function GET(request) {
    try {
      ...
      const history = await getCustomerTransactions(invoiceNumber, {});
      ...
      return new NextResponse(csv, {
        headers: {
          ...
          'Content-Disposition': `attachment; filename="credit_history_${invoiceNumber}_${format(new Date(), 'yyyy-MM-dd')}.csv"`
        }
      });
    } catch (error) {
